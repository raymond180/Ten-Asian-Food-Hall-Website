...
<!-- Link to index page -->
    ...
    <div class="container">
        ...
        <div class="py-5 text-center">
          <img src="./images/logo.jpg" class="rounded img-fluid" width="100" height="100">
          <h2>Edit Account</h2>
          <p class="lead">Edit your account information</p>
        </div>
      </div>
      <!-- Pulls info from customer info database -->
      <div class="row justify-content-md-center ">
        <div class="col-md-8 order-md-1">
          ...
          <form class="needs-validation" novalidate>
            ...
            <hr class="mb-4">
            <div class="mb-3">
              <label for="Current-Password">Enter Current Password <span class="text-muted"></span></label>
              <input type="Password" class="form-control" id="Password" placeholder="Current Password">
              <div class="invalid-feedback">
                Please enter a valid password. Must include at least 5 characters, and a capital letter
              </div>
            </div>

            <div class="mb-3">
              <label for="New-Password">Change Password <span class="text-muted"></span></label>
            ...
            <div class="mb-3">
              ...
              <input type="PhoneNumber" class="form-control" id="email" placeholder="(123) 555-1234">
              <div class="invalid-feedback">
            ...
            <h4 class="mb-3">Edit Payment Information</h4>
            ...
            <!-- Updates info and refreshes page -->
            <hr class="mb-4">
      ...
      <footer class="my-5 pt-5 text-muted text-center text-small">
        <p class="mb-1">&copy; 2018-2019 Ten Asian Food Hall</p>
...
>>>>>>> afe7ef42ec72ffc916d5a3762db8b1feab94de67:edit-account.php

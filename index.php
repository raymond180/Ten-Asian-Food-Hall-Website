            ...
            <div class="container about">
                <div class="row">
                    <div class="col-lg-4">
                        ...
                        <p><a class="btn btn-secondary" href="menu.php" role="button">View details &raquo;</a></p>
                    </div><!-- /.col-lg-4 -->
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-4">
                        <img class="rounded-circle" src="./images/dancing-eel.jpg" alt="Generic placeholder image" width="140" height="140">
                        <h2>Dancing Eel</h2>
